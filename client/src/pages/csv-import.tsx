...
function ColumnRow({ col, mappings, onMap }: {
  col: ColumnAnalysis;
        ...
        <div style={{ maxHeight: 260, overflowY: "auto", borderRadius: 8, border: "1px solid #1e293b" }}>
          {result.rows.map(row => (
            <div key={row.row} style={{
              ...
              <span style={{ width: 40, textAlign: "right", color: "#475569", fontVariantNumeric: "tabular-nums" }}>
                #{row.row}
              </span>
              <span style={{
  ...
  return (
    <div style={{
      ...
      <header style={{
        ...
        <span style={{ fontWeight: 600, color: "#f1f5f9", fontSize: 15 }}>Import Inventory</span>
      </header>
      ...
      <div style={{ maxWidth: 860, margin: "0 auto", padding: 32 }}>
        ...
        {step === 3 && analysis && (
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "200px 1fr 200px", gap: 12, padding: "8px 16px", marginBottom: 8 }}>
              <div style={{ fontSize: 11, color: "#475569", fontWeight: 600 }}>CSV COLUMN</div>
              <div style={{ fontSize: 11, color: "#475569", fontWeight: 600 }}>SAMPLE VALUES</div>
              <div style={{ fontSize: 11, color: "#475569", fontWeight: 600 }}>MAP TO FIELD</div>
            </div>
            ...
            <div style={{ maxHeight: 400, overflowY: "auto", paddingRight: 4 }}>
              {analysis.columns.map(col => (
                <ColumnRow
                  ...
                  col={col}
                  mappings={mappings}
                  onMap={(header, fieldKey) => setMappings(prev => ({ ...prev, [header]: fieldKey }))}
                />
              ))}
            </div>
            ...
            {!requiredMapped && (
              <div style={{
                ...
                background: "#451a03", border: "1px solid #92400e", color: "#fcd34d", fontSize: 13,
              }}>
